...
type Config struct {
	...
	DebugPprofPort string `yaml:"debug_pprof_port" env:"DEBUG_PPROF_PORT" env-default:"8883"`

	HTTPPort     string        `yaml:"http_port" env:"HTTP_PORT" env-default:"8083"`
	...
	GRPCPort string `yaml:"grpc_port" env:"GRPC_PORT" env-default:"9083"`
